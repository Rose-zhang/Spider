...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.download_item.setGeometry(QtCore.QRect(100, 560, 75, 23))
        ...
        self.display_download.setGeometry(QtCore.QRect(20, 50, 761, 471))
        ...
        self.display_download.setColumnCount(3)
        ...
        item = QtGui.QTableWidgetItem()
        self.display_download.setHorizontalHeaderItem(2, item)
        self.display_download.horizontalHeader().setDefaultSectionSize(250)
        self.display_download.horizontalHeader().setMinimumSectionSize(100)
        self.delete_item = QtGui.QPushButton(Form)
        self.delete_item.setGeometry(QtCore.QRect(20, 560, 61, 23))
        self.delete_item.setObjectName(_fromUtf8("delete_item"))
    ...
    def retranslateUi(self, Form):
        ...
        self.delete_item.setText(_translate("Form", "删除", None))
