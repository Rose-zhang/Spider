...
class Widget(QtGui.QMainWindow, Ui_Form):
    ...
    def download_link(self):
        try:
            ...
            self.download_link_job.signal_warning.connect(self.alter_message_download_link)
    ...
    def alter_message_download_link(self, message):
        self.progressBar.hide()
        QtGui.QMessageBox.information(self, u'警告', message, u'确定')

    def alter_message_download_item(self, message):
        QtGui.QMessageBox.information(self, u'警告', message, u'确定')
